  ...
  <q-page class="landing-page text-white overflow-hidden">
        ...
        <q-carousel-slide name="first" class="q-pa-none">
          <div class="hero-slide-content relative-position full-height flex flex-center">
            ...
            <div class="container relative-position q-pa-md z-top text-center">
               ...
               <h1 class="text-h1 text-weight-bold q-mb-md hero-title fade-in-up delay-100">
                  Transform Your <span class="text-gradient">Tuition Institute</span>
               </h1>
               <p class="text-h5 q-mb-xl hero-subtitle text-grey-5 fade-in-up delay-200">
                  The ultimate solution for modern education management.
               </p>
               <div class="q-gutter-md fade-in-up delay-300">
                  <q-btn to="/register" color="white" text-color="black" size="lg" label="Get Started" no-caps class="q-px-xl action-btn" />
               </div>
            </div>
        ...
        <q-carousel-slide name="second" class="q-pa-none">
           <div class="hero-slide-content relative-position full-height flex flex-center">
            ...
            <div class="container relative-position q-pa-md z-top text-center">
               ...
               <p class="text-h4 q-mb-xl text-white">QR Code Integration & SMS Alerts</p>
                <q-btn outline color="white" size="lg" label="Learn More" no-caps class="q-px-xl action-btn" />
            </div>
      ...
      <div class="container q-mx-auto q-px-md">
        <div class="glass-strip q-pa-lg rounded-borders">
          <div class="row q-col-gutter-lg text-center items-center">
            ...
            <div class="col-12 col-md-4 border-right-light">
              <div class="text-h2 text-weight-bolder text-gradient">10k+</div>
              <div class="text-uppercase text-caption text-weight-bold tracking-wide">
                Daily Users
              </div>
            </div>
            <div class="col-12 col-md-4">
              <div class="text-h2 text-weight-bolder text-gradient">99.9%</div>
              <div class="text-uppercase text-caption text-weight-bold tracking-wide">
                Uptime
              </div>
            </div>
    ...
    <section class="cta-section q-py-xl text-center relative-position bg-black">
      ...
      <div class="container q-mx-auto q-px-md q-py-xl z-top relative-position">
        <h2 class="text-h3 text-weight-bold q-mb-lg">Ready to Modernize?</h2>
        <p class="text-h6 text-grey-5 q-mb-xl max-width-md mx-auto">
        ...
        <q-btn
          ...
          no-caps
          class="q-px-xl rounded-borders shadow-20 glow-btn"
        />
      </div>
    </section>
  </q-page>
...
const features = [
  {
    ...
    description:
      'Manage complex student data with our clean, intuitive digital profile system.',
    image: featureStudentImg,
  },
  {
    title: 'Smart Attendance',
    description:
      'Next-gen QR scanning and automated seamless parent notifications.',
    image: featureAttendanceImg,
  },
  {
    title: 'Secure Payments',
    description:
      'Bank-grade encrypted transaction tracking and financial reporting.',
