            ...
            <q-form @submit="saveClass" class="q-gutter-md">
              ...
              <div class="row q-col-gutter-sm">
                ...
                <q-input 
                  ...
                  type="textarea" 
                  rows="4"
                  hint="Detailed information about the class (visible to students)"
                />
...
const openDialog = (cls = null) => {
    if (cls) {
        ...
        form.value = { subject: '', grade: '', day_of_week: 'Monday', start_time: '08:00', end_time: '10:00', fee: '', image_url: '', description: '' }
    }
    dialog.value = true
}
