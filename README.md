...
This project was a deep dive into modern full-stack architecture, utilizing a shared Supabase backend to bridge two distinct applications.

Key Technical Highlights:

-Tech Stack: Quasar (Vue 3) + Vite for a high-performance, mobile-first UI.

-State Management: Pinia for seamless data flow.
